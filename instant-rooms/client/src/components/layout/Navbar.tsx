    ...
    >
      <div className="max-w-6xl mx-auto px-6 md:px-10 flex items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <span
            className="font-black tracking-tight text-[1.1rem]"
        ...
        <div className="hidden md:flex items-center gap-1 mx-auto">
          {links.map((link) => (
            <button
              ...
              className="px-4 py-2 text-[0.875rem] font-medium rounded-lg transition-all duration-150"
              style={{
        ...
        <div className="hidden md:flex items-center gap-3 ml-auto">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-1.5 text-[0.875rem] font-medium transition-colors duration-150"
          ...
          <button
            ...
            className="btn-primary text-[0.8rem] py-2 px-4"
          >
            Create Room
          </button>
        </div>
        ...
        >
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="font-black tracking-tight text-[1.1rem]" style={{ color: "var(--color-text-primary)" }}>
                Drop
              </span>
            </div>
            <button
          ...
          <div className="flex flex-col gap-1 p-4">
            {links.map((link) => (
              <button
                key={link.id}
                onClick={() => scrollTo(link.id)}
                className="text-left text-xl font-semibold px-4 py-3 rounded-xl transition-colors"
                style={{ color: "var(--color-text-primary)" }}
                onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.background = "var(--color-surface-alt)")}
                onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.background = "transparent")}
              >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-left text-xl font-semibold px-4 py-3 rounded-xl flex items-center gap-2 transition-colors"
              style={{ color: "var(--color-text-primary)" }}
            >
              GitHub
